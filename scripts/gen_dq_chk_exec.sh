...
case "$env" in
                sit)
                echo $env >> ${LOGFILE}
                echo "spark-submit ${SPARK_SCRIPTS}/gen_dq_chk_spark.py  $dq_schema $app_nm $src_tbl"
                      spark-submit ${SPARK_SCRIPTS}/gen_dq_chk_spark.py  $dq_schema $app_nm $src_tbl
                ;;  
                home)
                echo $env >> ${LOGFILE}
				echo "spark-submit ${SPARK_SCRIPTS}/gen_dq_chk_spark.py  $dq_schema $app_nm $src_tbl"
